...
{
    public class CustomInputField : LensUISelectable,
        ...
        ILayoutElement
    {
        ...
        public float caretBlinkRate
        {
            ...
            set
            {
                if (SetProp(ref m_CaretBlinkRate, value))
                {
                    if (m_AllowInput)
                        SetCaretActive();
                }
        ...
        /// </summary>
        public int caretWidth { get { return m_CaretWidth; } set { if (SetProp(ref m_CaretWidth, value)) MarkGeometryAsDirty(); } }
        ...
        public Text textComponent
        {
            ...
            set
            {
                ...
                if (SetPropClass(ref m_TextComponent, value))
                {
                    EnforceTextHOverflow();
                    if (m_TextComponent != null)
                    {
        ...
        /// </remarks>
        public Graphic placeholder { get { return m_Placeholder; } set { SetPropClass(ref m_Placeholder, value); } }

        /// <summary>
        /// The custom caret color used if customCaretColor is set.
        /// </summary>
        public Color caretColor { get { return customCaretColor ? m_CaretColor : textComponent.color; } set { if (SetPropColor(ref m_CaretColor, value)) MarkGeometryAsDirty(); } }
        ...
        /// </code>
        /// </example>
        public Color selectionColor { get { return m_SelectionColor; } set { if (SetPropColor(ref m_SelectionColor, value)) MarkGeometryAsDirty(); } }
        ...
        /// </code>
        /// </example>
        public SubmitEvent onEndEdit { get { return m_OnEndEdit; } set { SetPropClass(ref m_OnEndEdit, value); } }
        ...
        /// </code>
        /// </example>
        public OnChangeEvent onValueChanged { get { return m_OnValueChanged; } set { SetPropClass(ref m_OnValueChanged, value); } }
        ...
        /// </code>
        /// </example>
        public OnValidateInput onValidateInput { get { return m_OnValidateInput; } set { SetPropClass(ref m_OnValidateInput, value); } }
        ...
        public int characterLimit
        {
            ...
            set
            {
                if (SetProp(ref m_CharacterLimit, Math.Max(0, value)))
                {
                    UpdateLabel();
                    if (m_Keyboard != null)
        ...
        /// </code>
        /// </example>
        public ContentType contentType { get { return m_ContentType; } set { if (SetPropEnum(ref m_ContentType, value)) EnforceContentType(); } }
        ...
        public LineType lineType
        {
            ...
            set
            {
                if (SetPropEnum(ref m_LineType, value))
                {
        ...
        /// </summary>
        public InputType inputType { get { return m_InputType; } set { if (SetPropEnum(ref m_InputType, value)) SetToCustom(); } }
        ...
        public TouchScreenKeyboardType keyboardType
        {
            ...
            set
            {
                if (SetPropEnum(ref m_KeyboardType, value))
                    SetToCustom();
            }
        }
        ...
        /// </summary>
        public CharacterValidation characterValidation { get { return m_CharacterValidation; } set { if (SetPropEnum(ref m_CharacterValidation, value)) SetToCustom(); } }
        ...
        /// </code>
        /// </example>
        public char asteriskChar { get { return m_AsteriskChar; } set { if (SetProp(ref m_AsteriskChar, value)) UpdateLabel(); } }
        ...
        protected override void OnDisable()
        {
            ...
            LiteCoroutine.StopCoroutine(m_BlinkCoroutine);
        ...
        void SetCaretActive()
        {
            ...
            {
                if (m_BlinkCoroutine.IsNullOrDone())
                {
                    LiteCoroutine.StartCoroutine(ref m_BlinkCoroutine, CaretBlink());
                }
            }
            else
            {
        ...
        private bool MayDrag(PointerEventData eventData)
        {
            return IsActive() &&
                IsInteractable() &&
                IsEffectiveButton(eventData.button) &&
        ...
        {
            if (m_DraggingPointer != null) { return; }
            if (!MayDrag(eventData)) { return; }

            m_DraggingPointer = eventData;
        }
        ...
        {
            if (m_DraggingPointer != eventData) { return; }
            if (!MayDrag(eventData)) { return; }
            ...
            if (m_DragPositionOutOfBounds && m_DragCoroutine.IsNullOrDone())
            {
                LiteCoroutine.StartCoroutine(ref m_DragCoroutine, MouseDragOutsideRect(eventData));
            }
        ...
        {
            while (m_DraggingPointer == eventData && m_DragPositionOutOfBounds)
            {
                Vector2 position = Vector2.zero;
        ...
        {
            if (m_DraggingPointer == eventData)
            {
                m_DraggingPointer = null;
            }
        }
        ...
        protected EditState KeyPressed(char keyChar, KeyCode keyCode, EventModifiers mods)
        {
            bool ctrl = (mods & (EventModifiers.Command | EventModifiers.Control)) != 0;
            ...
            switch (keyCode)
            {
                ...
                case KeyCode.C:
                    if (!ctrlOnly) { break; }
                    clipboard = inputType == InputType.Password ? "" : GetSelectedString();
                    return EditState.Continue;
                ...
                case KeyCode.Return:
                case KeyCode.KeypadEnter:
                    if (lineType == LineType.MultiLineNewline) { break; }
                    return EditState.Finish;
            ...
            // Don't allow return chars or tabulator key to be entered into single line fields.
            if (!multiLine && (keyChar == '\t' || keyChar == '\r' || keyChar == 10))
            {
                return EditState.Continue;
            }

            // Convert carriage return and end-of-text characters to newline.
            if (keyChar == '\r' || (int)keyChar == 3)
            {
                keyChar = '\n';
            }
        ...
        ///   "SelectAll"
        /// </summary>
        public void EnterKeyCode(char keyChar, KeyCode key, EventModifiers mod)
        {
            if (!isFocused) { return; }

            if (KeyPressed(keyChar, key, mod) == EditState.Finish)
            {
                DeactivateInputField();
            }
        ...
        public void EnterKeyCommand(string command, EventModifiers mod)
        {
            if (!isFocused) { return; }
            ...
            switch (command.ToLower())
            {
                ...
                default:
                    ...
                    {
                        EnterKeyCode(c, KeyCode.None, mod);
                    }
                    break;
            }
        ...
        {
            if (IsEffectiveButton(eventData.button))
            {
                ActivateInputField();
            }
        }
        ...
        private static bool SetProp<T>(ref T value, T newValue) where T : IEquatable<T>
        {
        ...
        private static bool SetPropEnum<T>(ref T value, T newValue) where T : Enum
        {
        ...
        private static bool SetPropClass<T>(ref T value, T newValue) where T : class
        {
        ...
        private static bool SetPropColor(ref Color value, Color newValue)
        {
            if (value.r == newValue.r && value.g == newValue.g && value.b == newValue.b && value.a == newValue.a) { return false; }
            value = newValue;
            return true;
        }
        /// <summary>
