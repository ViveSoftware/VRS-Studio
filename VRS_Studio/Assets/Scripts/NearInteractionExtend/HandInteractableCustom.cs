...
{
	public class HandInteractableCustom : BaseInteractable
	{
        ...
        #region Properties
        private HandInteractorCustom m_GrabHand = null;
		public HandInteractorCustom GrabHand { get { return m_GrabHand; } set { m_GrabHand = value; } }
		...
		private void BeginGrabActable(HandInteractorCustom hand)
		{
		...
		private void GrabbingActable(HandInteractorCustom hand)
		{
			if (!m_Grabbable) { return; }
			if (m_GrabHand == hand)
			{
		...
		private void EndGrabActable(HandInteractorCustom hand)
		{
			if (!m_Grabbable) { return; }
		...
		public void GrabBeginHandle(HandInteractorCustom hand)
		{
		...
		public void GrabbingHandle(HandInteractorCustom hand)
		{
			if (m_GrabHand == hand)
			{
		...
		public void GrabEndHandle(HandInteractorCustom hand)
		{
			if (m_GrabHand == hand)
			{
