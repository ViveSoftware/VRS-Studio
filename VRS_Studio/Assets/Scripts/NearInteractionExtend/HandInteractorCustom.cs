...
{
	public class HandInteractorCustom : BaseInteractor
	{
		...
		[SerializeField]
		private NearJoint m_Joint = NearJoint.Wrist;
		public NearJoint Joint { get { return m_Joint; } set { m_Joint = value; } }
		...
		private HandInteractableCustom m_GrabbedObject = null;
		public HandInteractableCustom GrabbedObject { get { return m_GrabbedObject; } set { m_GrabbedObject = value; } }
		public bool isGrabbing { get { return (m_GrabbedObject != null); } }

		private List<HandInteractableCustom> m_GrabCandidates = new List<HandInteractableCustom>();
		public List<HandInteractableCustom> GrabCandidates { get { return m_GrabCandidates; } }
		#endregion
		...
		private GrabClassifierCustom m_GrabClassifier = null;
		...
		private void HandleGrabMotion()
		{
			...
			if (m_GrabClassifier == null) {
				...
				m_GrabClassifier = new GrabClassifierCustom(this, SphereCollidingRadius, CollidingLayerMask, QueryTrigger);
			}
		...
		private void UpdateGrabCandidates(ref List<HandInteractableCustom> candidates)
		{
			/// Calculates the sphere colliding candidates.
			candidates.Clear();
			int collidingCount = GrabClassifierCustom.GetSphereColliderResults(
			...
			for (int i = 0; i < collidingCount; i++)
			{
				...
				{
					HandInteractableCustom actable = value.actable.GetComponent<HandInteractableCustom>();
		...
		private void CheckGrabBegin()
		{
			...
			HandInteractableCustom newGrabObject = null;
		...
		private void CheckGrabEnd()
		{
			...
			HandInteractableCustom releaseObject = null;
