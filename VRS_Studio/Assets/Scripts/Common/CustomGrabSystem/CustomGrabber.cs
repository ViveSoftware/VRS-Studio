...
namespace VRSStudio.Input.CustomGrab
{
    ...
    {
        private static string TAG = "CustomGrabber";
        ...
        private void UpdateGrabbedObjectPose()
        {
            ...
            grabbedRb.transform.position = Vector3.SmoothDamp(grabbedRb.transform.position, grabAnchor.position, ref vel, 0.016f);
            grabbedRb.transform.rotation = Quaternion.Slerp(grabbedRb.transform.rotation, grabAnchor.rotation, vel.magnitude);
        }
