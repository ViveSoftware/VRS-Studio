...
#region Compositor Layer Editor
	...
	public class CompositorLayerEditor : Editor
	{
		...
		static string PropertyName_UseCustomUnderlayAlphaShaderPath = "useCustomUnderlayAlphaShaderPath";
		static GUIContent Label_UseCustomUnderlayAlphaShaderPath = new GUIContent("Enable Custom Underlay Alpha Shader Path");
		SerializedProperty Property_UseCustomUnderlayAlphaShaderPath;

		static string PropertyName_CustomUnderlayAlphaShaderPath = "customUnderlayAlphaShaderPath";
		static GUIContent Label_CustomUnderlayAlphaShaderPath = new GUIContent("Custom Underlay Alpha Shader Path");
		SerializedProperty Property_CustomUnderlayAlphaShaderPath;

		static string PropertyName_UseCustomTextureBlitShaderPath = "useCustomTextureBlitShaderPath";
		static GUIContent Label_UseCustomTextureBlitShaderPath = new GUIContent("Enable Custom Texture Blit Shader Path");
		SerializedProperty Property_UseCustomTextureBlitShaderPath;

		static string PropertyName_CustomTextureBlitShaderPath = "customTextureBlitShaderPath";
		static GUIContent Label_CustomTextureBlitShaderPath = new GUIContent("Custom Texture Blit Shader Path");
		SerializedProperty Property_CustomTextureBlitShaderPath;
		...
		static GUIContent Label_IsExternalSurface = new GUIContent("External Surface");
		...
		private bool showExternalSrfaceParams = false;
		...
		public override void OnInspectorGUI()
		{
			...
			if (Property_UseCustomUnderlayAlphaShaderPath == null) Property_UseCustomUnderlayAlphaShaderPath = serializedObject.FindProperty(PropertyName_UseCustomUnderlayAlphaShaderPath);
			if (Property_CustomUnderlayAlphaShaderPath == null) Property_CustomUnderlayAlphaShaderPath = serializedObject.FindProperty(PropertyName_CustomUnderlayAlphaShaderPath);
			if (Property_UseCustomTextureBlitShaderPath == null) Property_UseCustomTextureBlitShaderPath = serializedObject.FindProperty(PropertyName_UseCustomTextureBlitShaderPath);
			if (Property_CustomTextureBlitShaderPath == null) Property_CustomTextureBlitShaderPath = serializedObject.FindProperty(PropertyName_CustomTextureBlitShaderPath);
			...
			if (targetCompositorLayer.isExternalSurface)
			{
				EditorGUI.indentLevel++;
				showExternalSrfaceParams = EditorGUILayout.Foldout(showExternalSrfaceParams, "External Surface Parameters");
				if (showExternalSrfaceParams)
				{
			...
			{
				EditorGUILayout.PropertyField(Property_UseCustomUnderlayAlphaShaderPath, new GUIContent(Label_UseCustomUnderlayAlphaShaderPath));
				serializedObject.ApplyModifiedProperties();

				if (targetCompositorLayer.useCustomUnderlayAlphaShaderPath)
				{
					EditorGUI.indentLevel++;
					EditorGUILayout.PropertyField(Property_CustomUnderlayAlphaShaderPath, new GUIContent(Label_CustomUnderlayAlphaShaderPath));
					serializedObject.ApplyModifiedProperties();
					EditorGUI.indentLevel--;
				}
			}

			EditorGUILayout.PropertyField(Property_UseCustomTextureBlitShaderPath, new GUIContent(Label_UseCustomTextureBlitShaderPath));
			serializedObject.ApplyModifiedProperties();

			if (targetCompositorLayer.useCustomTextureBlitShaderPath)
			{
				EditorGUI.indentLevel++;
				EditorGUILayout.PropertyField(Property_CustomTextureBlitShaderPath, new GUIContent(Label_CustomTextureBlitShaderPath));
				serializedObject.ApplyModifiedProperties();
				EditorGUI.indentLevel--;
			}
		}
