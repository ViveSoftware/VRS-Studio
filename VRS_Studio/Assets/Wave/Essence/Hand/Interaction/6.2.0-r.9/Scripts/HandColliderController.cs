...
namespace Wave.Essence.Hand.Interaction
{
	public class HandColliderController : MonoBehaviour
	{
		...
		const string LOG_TAG = "Wave.Essence.Hand.Interaction.HandColliderController";
		...
		private HandMeshRenderer m_HandMesh;
		public HandMeshRenderer handMesh { get { return m_HandMesh; } set { m_HandMesh = value; } }
		...
		private void Start()
		{
			JointCollider[] fullJointsCollider = FindObjectsOfType<JointCollider>();
		...
		private IEnumerator WaitForInit()
		{
			...
			if (rootJoint != null)
			{
				...
				sb.Clear().Append("Hand Collider init successfully.");
				DEBUG(sb);
			}
		}
